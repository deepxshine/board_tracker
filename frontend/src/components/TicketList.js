...
import CloseTicketModal from './TicketComponents/CloseTicketModal'; // Import your new modal
import InventoryDetailsModal from './TicketComponents/InventoryDetailsModal'; // Import Inventory Details Modal
