...
const TicketForm = ({ visible, onClose }) => {
    ...
    const [showInventoryModal, setShowInventoryModal] = useState(false); // State for showing inventory modal
    ...
    const resetState = () => {
        ...
        setShowInventoryModal(false); // Reset inventory modal visibility
    };
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            ...
            // Show the inventory modal after ticket creation
